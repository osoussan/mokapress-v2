...
#include "../../../../../client/src/gui/ocsjob.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OCC__OcsJob_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 31, 8), // "ocsError"
QT_MOC_LITERAL(5, 40, 10), // "statusCode"
QT_MOC_LITERAL(6, 51, 7), // "message"
QT_MOC_LITERAL(7, 59, 5), // "start"
QT_MOC_LITERAL(8, 65, 8) // "finished"

    },
    "OCC::OcsJob\0jobFinished\0\0reply\0ocsError\0"
    "statusCode\0message\0start\0finished"
};
...
void OCC::OcsJob::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OcsJob *_t = static_cast<OcsJob *>(_o);
        switch (_id) {
        case 0: _t->jobFinished((*reinterpret_cast< QVariantMap(*)>(_a[1]))); break;
        ...
        {
            typedef void (OcsJob::*_t)(QVariantMap );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OcsJob::jobFinished)) {
                *result = 0;
            }
        }
        {
            typedef void (OcsJob::*_t)(int , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OcsJob::ocsError)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject OCC::OcsJob::staticMetaObject = {
    { &AbstractNetworkJob::staticMetaObject, qt_meta_stringdata_OCC__OcsJob.data,
      qt_meta_data_OCC__OcsJob,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OCC::OcsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OCC__OcsJob.stringdata))
        return static_cast<void*>(const_cast< OcsJob*>(this));
...
// SIGNAL 0
void OCC::OcsJob::jobFinished(QVariantMap _t1)
{
