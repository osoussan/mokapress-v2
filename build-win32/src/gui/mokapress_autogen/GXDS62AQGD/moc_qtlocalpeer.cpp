...
#include "../../../../../client/src/3rdparty/qtsingleapplication/qtlocalpeer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SharedTools__QtLocalPeer_t, stringdata) + ofs \
...
void *SharedTools::QtLocalPeer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SharedTools__QtLocalPeer.stringdata))
