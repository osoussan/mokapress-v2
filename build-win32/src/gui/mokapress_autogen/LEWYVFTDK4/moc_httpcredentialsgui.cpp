...
#include "../../../../../client/src/gui/creds/httpcredentialsgui.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OCC__HttpCredentialsGui_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 24, 16), // "askFromUserAsync"
QT_MOC_LITERAL(2, 41, 0) // ""

    },
    "OCC::HttpCredentialsGui\0askFromUserAsync\0"
    ""
};
...
void OCC::HttpCredentialsGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HttpCredentialsGui *_t = static_cast<HttpCredentialsGui *>(_o);
        switch (_id) {
        case 0: _t->askFromUserAsync(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject OCC::HttpCredentialsGui::staticMetaObject = {
    { &HttpCredentials::staticMetaObject, qt_meta_stringdata_OCC__HttpCredentialsGui.data,
      qt_meta_data_OCC__HttpCredentialsGui,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OCC::HttpCredentialsGui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OCC__HttpCredentialsGui.stringdata))
        return static_cast<void*>(const_cast< HttpCredentialsGui*>(this));
