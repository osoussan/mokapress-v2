...
public:
    ...
    QPushButton *languageFilesButton;
    ...
    void setupUi(QWidget *OCC__GeneralSettings)
    {
        ...
        languageFilesButton = new QPushButton(groupBox);
        languageFilesButton->setObjectName(QStringLiteral("languageFilesButton"));

        gridLayout->addWidget(languageFilesButton, 0, 0, 1, 1);
        ...
        QWidget::setTabOrder(monoIconsCheckBox, languageFilesButton);
        QWidget::setTabOrder(languageFilesButton, newFolderLimitCheckBox);
    ...
    void retranslateUi(QWidget *OCC__GeneralSettings)
    {
        ...
        languageFilesButton->setText(QApplication::translate("OCC::GeneralSettings", "Language Settings", 0));
