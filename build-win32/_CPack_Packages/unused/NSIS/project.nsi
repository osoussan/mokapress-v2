...
!define APPLICATION_EXECUTABLE "mokapress.exe"
!define APPLICATION_CMD_EXECUTABLE "mokapresscmd.exe"
!define APPLICATION_DOMAIN "mokapress.com"
!define APPLICATION_LICENSE ""
!define WIN_SETUP_BITMAP_PATH "/home/user/mokapresstheme/win"
...
!define BUILD_PATH "/home/user/build-win32"
!define SOURCE_PATH "/home/user/client"
...
OutFile "/home/user/build-win32/_CPack_Packages/unused/NSIS/Mokapress-2.2.3.0-setup.exe"
InstallDir "$PROGRAMFILES\Mokapress"
...
!ifdef OPTION_FINISHPAGE_LAUNCHER
   !define MUI_FINISHPAGE_TEXT "Mokapress necessite un redemarrage pour fonctionner correctement." 
...
Section "${APPLICATION_NAME}" SEC_APPLICATION
   ...
   File "/usr/share/cmake/Templates/CPack.GenericLicense.txt"
