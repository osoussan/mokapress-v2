...
#ifndef MOKAPRESS_THEME_H
#define MOKAPRESS_THEME_H
...
/**
 * @brief The MokapressTheme class
 * @ingroup libsync
 */
class MokapressTheme : public Theme
{
...
public:
    ...
    QString configFileName() const  {
        return QLatin1String("mokapress.cfg");
    }

    QIcon trayFolderIcon( const QString& ) const  {
        return themeIcon( QLatin1String("Mokapress-icon") );
    }
    ...
    QString updateCheckUrl() const {
        return QLatin1String("https://mokapress.com/updates/client/");
    }

    QString helpUrl() const {
        return QString::fromLatin1("https://mokapress.com/doc/desktop/2.2/").arg(MIRALL_VERSION_MAJOR).arg(MIRALL_VERSION_MINOR);
    }
