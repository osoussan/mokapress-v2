...
#include "../../../client/src/3rdparty/qtsingleapplication/qtsingleapplication.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SharedTools__QtSingleApplication_t, stringdata) + ofs \
...
void *SharedTools::QtSingleApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SharedTools__QtSingleApplication.stringdata))
