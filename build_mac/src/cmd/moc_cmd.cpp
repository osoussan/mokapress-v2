...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Cmd_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Cmd_t qt_meta_stringdata_Cmd = {
    {
QT_MOC_LITERAL(0, 0, 3), // "Cmd"
QT_MOC_LITERAL(1, 4, 24), // "transmissionProgressSlot"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "Cmd\0transmissionProgressSlot\0"
};
...
void *Cmd::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cmd.stringdata))
